        ...
        private void LoadChartByYear()
        {
            ...
            foreach (var item in years)
            {
                if (Type.Contains("Amenities Sold"))
                {
                    ...
                    chartDetail.Series[0].Points.AddXY(item.ToString(), yvalue);
                    chartDetail.Series[0].Points[pointIndex].Label = yvalue.ToString();
                }
        ...
        private void LoadChartByMonthInYear()
        {
            ...
            for (int i = 1; i < 13; i++)
            {
                if (Type.Contains("Amenities Sold"))
                {
                    ...
                    chartDetail.Series[0].Points.AddXY(i.ToString("00"), yvalue);
                    chartDetail.Series[0].Points[pointIndex].Label = yvalue.ToString();
                ...
                else
                {
                    ...
                    chartDetail.Series[0].Points.AddXY(i.ToString("00"), yvalue);
                    chartDetail.Series[0].Points[pointIndex].Label = yvalue.ToString("C0");
                }
        ...
        private void LoadChartByDateInMonth()
        {
            ...
            for (DateTime i = from; i < to; i = i.AddDays(1))
            {
                if (Type.Contains("Amenities Sold"))
                {
                    ...
                    chartDetail.Series[0].Points.AddXY(i.ToString("dd"), yvalue);
                    chartDetail.Series[0].Points[pointIndex].Label = yvalue.ToString("C0");
                }
                else if (Type.Contains("Tickets Sold"))
                {
